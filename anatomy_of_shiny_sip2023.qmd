...
- Variety of solutions - shiny apps
...
:::{.notes}
- Can think of an app as a person
...
- (maybe tenuous) can indirectly interact with organs i.e. increase stamina -> bigger lungs, but you don't have to worry about how the lungs operate
...
- Lots of people, especially those new to R and/or shiny will view it as magic
- It is just clever coding and good design E.g. it kind of boils down to just a while(running) check_if_changes; if_yes_then_do_stuff; loop
...
- Context like a function with extra attributes
...
:::{.notes}
- More complicated than reactive values is a reactive expression
